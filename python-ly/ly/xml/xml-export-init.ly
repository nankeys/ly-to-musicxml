...
%% Cover both explicit \book parsing and end-of-input default book handling.
#(define print-book-with-defaults
  (make-toplevel-book-handler->xml xml-outputter))
